...
$(".train>li").css("width",100/slides+"%")
let trans=$(".train>li").width();
...
$(".btnNext1").click(function(){
  ...
  $(".train").css("transform","translateX("+-trans*count+"px)")
})
//탭메뉴1 prev
...
let count1=0
let slides1=$(".train2>li").length;
$(".train2").css("width",100*slides1+"%")
$(".train2>li").css("width",100/slides1+"%")
let trans1=$(".train>li").width();
...
$(".btnPrev2").click(function(){
  ...
  $(".train2").css("transform","translateX("+-trans1*count1+"px)")
})
...
$(".btnNext2").click(function(){
  ...
  $("dl>dt").click(function() {
    $("dl>dt").removeClass("tabon").css("background","#f8f8f8").css("color","black")
    $(this).addClass("tabon").css("background","#191919").css("color","#fff")
